...
TORCH_VERSION=v2.7.0
TORCHVISION_VERSION=v0.21.0
...
echo "==================================================================="
echo "        vLLM FULL BUILD START (v0.10.0)"
echo "==================================================================="
...
yum install -y \
  ...
  cargo libcurl-devel \
  which procps-ng libatomic libsndfile\
  --allowerasing
...
python3.12 -m pip install \
  --trusted-host https://wheels.developerfirst.ibm.com/ppc64le/linux --prefer-binary \
...
python3.12 -m pip install wheelhouse/pyarrow-${PYARROW_VERSION}-*.whl
...
echo "==================================================================="
echo "               vLLM WHEEL BUILT SUCCESSFULLY (v0.10.0)"
echo "==================================================================="

python3.12 -m pip install "transformers<=4.57.3"
